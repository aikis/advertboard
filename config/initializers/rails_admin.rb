# RailsAdmin config file. Generated on March 30, 2012 13:28
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Advertboard', 'Admin']
  ...
  # config.excluded_models = [Advert, Comment, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Advert, Comment, User]
  ...
  #   # Found associations:
  #     configure :user, :belongs_to_association 
  #     configure :advert, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :text, :text 
  #     configure :user_id, :integer         # Hidden 
  #     configure :advert_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  ...
  #   # Found associations:
  #     configure :adverts, :has_many_association 
  #     configure :comments, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
